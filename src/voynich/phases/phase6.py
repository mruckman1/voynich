...
from voynich.modules.phase6.fixed_saa import FixedSAA
from voynich.modules.phase6.homophone_detector import HomophoneDetector
from voynich.modules.phase6.homophone_merger import HomophoneMerger
from voynich.modules.phase6.reduced_saa import ReducedSAA
from voynich.modules.phase6.morpheme_analyzer import MorphemeAnalyzer
from voynich.modules.phase6.boundary_analyzer import BoundaryAnalyzer

def run_phase6_attack(
    paths: Optional[List[str]] = None,
    verbose: bool = True,
    output_dir: str = './results/phase6',
