...
from voynich.modules.phase8.viterbi_decoder import ViterbiDecoder
from voynich.modules.phase8.morphological_synthesizer import MorphologicalSynthesizer
from voynich.modules.phase8.folio_translator import FolioTranslator

def load_phase7_data(filepath: str = './results/phase7/phase7_report.json') -> Dict:
    with open(filepath, 'r') as f:
        return json.load(f)

def run_phase8_translation(verbose: bool = True, output_dir: str = './results/phase8') -> Dict:
