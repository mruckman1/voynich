...
from voynich.modules.phase12_5.adv_1_unicity_distance import UnicityDistanceTest
from voynich.modules.phase12_5.adv_2_domain_swap import DomainSwapTest
from voynich.modules.phase12_5.adv_3_polyglot_dict import PolyglotDictTest
from voynich.modules.phase12_5.adv_4_eva_collapse import EvaCollapseTest
from voynich.modules.phase12_5.adv_5_ablation_study import AblationStudyTest
from voynich.modules.phase12_5.proof_of_compositionality import CompositionalityProof
...
def run_phase12_5_adversarial(
    ...
    verbose: bool = True,
    output_dir: str = './results/phase12_5',
    ...
    if 'dictionary_diagnostic' in run_phases:
        ...
        from voynich.modules.phase12_5.dictionary_diagnostic import DictionaryDiagnostic
