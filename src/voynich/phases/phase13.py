...
from voynich.core.utils import save_json, ensure_output_dir, make_results_header
from voynich.core.config import LATIN_CORPUS_TOKENS_LARGE, MIN_CONFIDENCE_RATIO
...
def _find_phase_output(phase_num: int, filename: str) -> str:
    ...
    candidates = [
        f'./results/phase{phase_num}/{filename}',
...
def run_phase13_synthesis(
    ...
    verbose: bool = True,
    output_dir: str = './results/phase13',
    ...
    **_kwargs,
    ...
    if 'correlation' in run_phases:
        ...
        from voynich.modules.phase13.illustration_correlation import run_illustration_correlation
