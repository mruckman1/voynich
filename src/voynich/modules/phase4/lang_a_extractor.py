...
from voynich.modules.phase3.lang_a_reprofiling import LANG_A_TARGETS
...
class LanguageAExtractor:
    ...
    def __init__(self, corpus_dir: str = None, verbose: bool = True):
        if corpus_dir is None:
            from voynich.core._paths import corpus_dir as _cd
            corpus_dir = str(_cd())
    ...
    def _load_corpus(self):
        ...
        try:
            from voynich.core.ivtff_parser import load_corpus
