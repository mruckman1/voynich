...
from voynich.phases.robustness import run_full_pipeline, _compute_content_metrics
...
class DiscriminantAnalysis:
    ...
    def _collect_phase14_metrics(
        ...
        from voynich.modules.phase14.semantic_coherence import SemanticCoherenceAnalyzer
    ...
    def _collect_phase13_metrics(
        ...
        from voynich.modules.phase13.illustration_correlation import (
    ...
    def _collect_consistency_metrics(
        ...
        """
        from voynich.modules.robustness.consistency_significance import _binomial_p_value
