...
from voynich.core.stats import compute_all_entropy, full_statistical_profile
from voynich.core.voynich_corpus import get_all_tokens
...
def run(verbose: bool = True, phase_results: Optional[Dict] = None) -> Dict:
    ...
    try:
        ...
        with open('./results/constraint_model.json', 'w') as f:
